...
func RegisterCommands(app *kingpin.Application) Application {
	...
	tele.ListCmd.CmdClause = app.Command("ls", "Display a list of user applications published in remote Gravity Hub")
	...
	tele.PullCmd.CmdClause = app.Command("pull", "Pull an application from remote Gravity Hub")
