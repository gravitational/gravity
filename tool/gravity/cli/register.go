...
func RegisterCommands(app *kingpin.Application) *Application {
	...
	g.InstallCmd.AdmissionPlugins = g.InstallCmd.Flag("admission-plugins", "List of Kubernetes admission plugins to enable. These will be enabled along with the default plugins.").Strings()
