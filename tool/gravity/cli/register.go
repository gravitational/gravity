...
func RegisterCommands(app *kingpin.Application) *Application {
	...
	g.SystemPullUpdatesCmd.PackageUpdates.RuntimePackage = Locator(g.SystemPullUpdatesCmd.Flag("runtime-package", "Runtime package update").Required())
	g.SystemPullUpdatesCmd.PackageUpdates.RuntimeConfigPackage = Locator(g.SystemPullUpdatesCmd.Flag("runtime-config-package", "Runtime configuration package update").Required())
	g.SystemPullUpdatesCmd.PackageUpdates.RuntimeSecretsPackage = OptionalLocator(g.SystemPullUpdatesCmd.Flag("runtime-secrets-package", "Runtime secrets package update"))
	g.SystemPullUpdatesCmd.PackageUpdates.TeleportPackage = OptionalLocator(g.SystemPullUpdatesCmd.Flag("teleport-package", "Teleport package update"))
	g.SystemPullUpdatesCmd.PackageUpdates.TeleportConfigPackage = OptionalLocator(g.SystemPullUpdatesCmd.Flag("teleport-config-package", "Teleport configuration package update"))
	...
	g.SystemUpdateCmd.PackageUpdates.RuntimePackage = Locator(g.SystemUpdateCmd.Flag("runtime-package", "Runtime package update").Required())
	g.SystemUpdateCmd.PackageUpdates.RuntimeConfigPackage = Locator(g.SystemUpdateCmd.Flag("runtime-config-package", "Runtime configuration package update").Required())
	g.SystemUpdateCmd.PackageUpdates.RuntimeSecretsPackage = OptionalLocator(g.SystemUpdateCmd.Flag("runtime-secrets-package", "Runtime secrets package update"))
	g.SystemUpdateCmd.PackageUpdates.TeleportPackage = OptionalLocator(g.SystemUpdateCmd.Flag("teleport-package", "Teleport package update"))
	g.SystemUpdateCmd.PackageUpdates.TeleportConfigPackage = OptionalLocator(g.SystemUpdateCmd.Flag("teleport-config-package", "Teleport configuration package update"))
...
// OptionalLocator defines a command line flag that accepts input
// in package locator format.
// It can handle empty input in which case the locator might be nil
func OptionalLocator(s kingpin.Settings) (loc *MaybeLocator) {
	loc = &MaybeLocator{}
	s.SetValue(loc)
	return loc
}

// Set sets a new value for the locator.
// It does not fail for empty v
func (r *MaybeLocator) Set(v string) error {
	if v == "" {
		// Empty input
		return nil
	}
...
// MaybeLocator is a package locator with empty semantics
type MaybeLocator struct {
	*loc.Locator
}
