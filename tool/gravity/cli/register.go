...
func RegisterCommands(app *kingpin.Application) *Application {
	...
	g.SystemUpdateCmd.RuntimePackage = Locator(g.SystemUpdateCmd.Flag("runtime-package", "Name of the runtime package to update to").Required())
	g.SystemUpdateCmd.RuntimeConfigPackage = Locator(g.SystemUpdateCmd.Flag("runtime-config-package", "Name of the runtime configuration package to update to").Required())
	g.SystemUpdateCmd.RuntimeSecretsPackage = Locator(g.SystemUpdateCmd.Flag("runtime-secrets-package", "Name of the runtime secrets package to update to").Required())
	g.SystemUpdateCmd.TeleportPackage = Locator(g.SystemUpdateCmd.Flag("teleport-package", "Name of the teleport package to update to").Required())
	g.SystemUpdateCmd.TeleportConfigPackage = Locator(g.SystemUpdateCmd.Flag("teleport-config-package", "Name of the teleport configuration package to update to").Required())
