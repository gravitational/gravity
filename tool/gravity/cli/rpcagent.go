...
func verifyCluster(ctx context.Context, req deployAgentsRequest) (verified []rpc.DeployServer, err error) {
	var missing []string
	verified = make([]rpc.DeployServer, 0, len(req.clusterState.Servers))
