...
func (x ExecOutput_FD) String() string {
	return proto1.EnumName(ExecOutput_FD_name, int32(x))
}
func (ExecOutput_FD) EnumDescriptor() ([]byte, []int) { return fileDescriptorAgent, []int{5, 0} }
...
func (x LogEntry_Level) String() string {
	return proto1.EnumName(LogEntry_Level_name, int32(x))
}
func (LogEntry_Level) EnumDescriptor() ([]byte, []int) { return fileDescriptorAgent, []int{6, 0} }
...
func (m *CommandArgs) String() string            { return proto1.CompactTextString(m) }
func (*CommandArgs) ProtoMessage()               {}
func (*CommandArgs) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{0} }
...
func (*Message) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{1} }
...
type Message_ExecStarted struct {
	ExecStarted *ExecStarted `protobuf:"bytes,1,opt,name=exec_started,json=execStarted,oneof"`
}
type Message_ExecCompleted struct {
	ExecCompleted *ExecCompleted `protobuf:"bytes,2,opt,name=exec_completed,json=execCompleted,oneof"`
}
type Message_ExecOutput struct {
	ExecOutput *ExecOutput `protobuf:"bytes,3,opt,name=exec_output,json=execOutput,oneof"`
}
type Message_LogEntry struct {
	LogEntry *LogEntry `protobuf:"bytes,4,opt,name=log_entry,json=logEntry,oneof"`
}
...
func _Message_OneofSizer(msg proto1.Message) (n int) {
	...
	switch x := m.Element.(type) {
	case *Message_ExecStarted:
		s := proto1.Size(x.ExecStarted)
		n += proto1.SizeVarint(1<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Message_ExecCompleted:
		s := proto1.Size(x.ExecCompleted)
		n += proto1.SizeVarint(2<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Message_ExecOutput:
		s := proto1.Size(x.ExecOutput)
		n += proto1.SizeVarint(3<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Message_LogEntry:
		s := proto1.Size(x.LogEntry)
...
func (m *ExecStarted) String() string            { return proto1.CompactTextString(m) }
func (*ExecStarted) ProtoMessage()               {}
func (*ExecStarted) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{2} }
...
func (m *ExecCompleted) String() string            { return proto1.CompactTextString(m) }
func (*ExecCompleted) ProtoMessage()               {}
func (*ExecCompleted) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{3} }
...
type Error struct {
	...
	Traces []string `protobuf:"bytes,2,rep,name=traces" json:"traces,omitempty"`
}

func (m *Error) Reset()                    { *m = Error{} }
func (m *Error) String() string            { return proto1.CompactTextString(m) }
func (*Error) ProtoMessage()               {}
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{4} }
...
func (m *ExecOutput) String() string            { return proto1.CompactTextString(m) }
func (*ExecOutput) ProtoMessage()               {}
func (*ExecOutput) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{5} }
...
type LogEntry struct {
	Message string            `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	Fields  map[string]string `protobuf:"bytes,2,rep,name=fields" json:"fields,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Level   LogEntry_Level    `protobuf:"varint,3,opt,name=level,proto3,enum=proto.LogEntry_Level" json:"level,omitempty"`
	Traces  []string          `protobuf:"bytes,4,rep,name=traces" json:"traces,omitempty"`
}

func (m *LogEntry) Reset()                    { *m = LogEntry{} }
func (m *LogEntry) String() string            { return proto1.CompactTextString(m) }
func (*LogEntry) ProtoMessage()               {}
func (*LogEntry) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{6} }
...
func (m *PeerJoinRequest) String() string            { return proto1.CompactTextString(m) }
func (*PeerJoinRequest) ProtoMessage()               {}
func (*PeerJoinRequest) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{7} }
...
func (m *PeerLeaveRequest) String() string            { return proto1.CompactTextString(m) }
func (*PeerLeaveRequest) ProtoMessage()               {}
func (*PeerLeaveRequest) Descriptor() ([]byte, []int) { return fileDescriptorAgent, []int{8} }
...
func init() {
	proto1.RegisterType((*CommandArgs)(nil), "proto.CommandArgs")
	proto1.RegisterType((*Message)(nil), "proto.Message")
	proto1.RegisterType((*ExecStarted)(nil), "proto.ExecStarted")
	proto1.RegisterType((*ExecCompleted)(nil), "proto.ExecCompleted")
	proto1.RegisterType((*Error)(nil), "proto.Error")
	proto1.RegisterType((*ExecOutput)(nil), "proto.ExecOutput")
	proto1.RegisterType((*LogEntry)(nil), "proto.LogEntry")
	proto1.RegisterType((*PeerJoinRequest)(nil), "proto.PeerJoinRequest")
	proto1.RegisterType((*PeerLeaveRequest)(nil), "proto.PeerLeaveRequest")
	proto1.RegisterEnum("proto.ExecOutput_FD", ExecOutput_FD_name, ExecOutput_FD_value)
	proto1.RegisterEnum("proto.LogEntry_Level", LogEntry_Level_name, LogEntry_Level_value)
}
...
type AgentClient interface {
	...
	PeerJoin(ctx context.Context, in *PeerJoinRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
	// PeerLeave receives a "leave" request from a peer and initiates its shutdown
	PeerLeave(ctx context.Context, in *PeerLeaveRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
}
...
func (c *agentClient) Shutdown(ctx context.Context, in *google_protobuf.Empty, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/proto.Agent/Shutdown", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) Command(ctx context.Context, in *CommandArgs, opts ...grpc.CallOption) (Agent_CommandClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Agent_serviceDesc.Streams[0], c.cc, "/proto.Agent/Command", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *agentClient) PeerJoin(ctx context.Context, in *PeerJoinRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/proto.Agent/PeerJoin", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) PeerLeave(ctx context.Context, in *PeerLeaveRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/proto.Agent/PeerLeave", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServer interface {
	...
	// The peer configuration allows this agent to establish a reverse
	// connection to the remote peer to execute remote commands
	PeerJoin(context.Context, *PeerJoinRequest) (*google_protobuf.Empty, error)
	// PeerLeave receives a "leave" request from a peer and initiates its shutdown
	PeerLeave(context.Context, *PeerLeaveRequest) (*google_protobuf.Empty, error)
}
...
func _Agent_Shutdown_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).Shutdown(ctx, req.(*google_protobuf.Empty))
	}
...
func init() { proto1.RegisterFile("agent.proto", fileDescriptorAgent) }

var fileDescriptorAgent = []byte{
	// 773 bytes of a gzipped FileDescriptorProto
	,
}
