...
var (
	...
	// GravityServiceAbsoluteURL defines the address the internal gravity site is located
	GravityServiceAbsoluteURL = fmt.Sprintf("https://%s.:%d", GravityServiceHost, GravityServicePort)
