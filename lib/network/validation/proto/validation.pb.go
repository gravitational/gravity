...
type ValidateRequest struct {
	...
	// Docker specifies the Docker configuration overrides
...
// Docker describes Docker configuration overrides for validation
type Docker struct {
	// StorageDriver specifies the storage driver to validate
