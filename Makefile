...
PLANET_TAG := 7.1.23-$(K8S_VER_SUFFIX)-15-g3afcd629
PLANET_BRANCH := $(PLANET_TAG)
K8S_APP_TAG := $(GRAVITY_TAG)
TELEKUBE_APP_TAG := $(GRAVITY_TAG)
WORMHOLE_APP_TAG := $(GRAVITY_TAG)
INGRESS_APP_TAG ?= 0.0.1
STORAGE_APP_TAG ?= 0.0.4-rc.1
LOGGING_APP_TAG ?= 7.1.0-rc.1
MONITORING_APP_TAG ?= 7.1.4-rc.1
DNS_APP_TAG = 7.1.2
BANDWAGON_TAG ?= 7.1.0-rc.1
