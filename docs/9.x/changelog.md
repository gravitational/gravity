...
| ------------------- | ------------- | --- | -------------------- | ----------------------- | -------------------- | ---------------- |
| [9.0](#90-releases) | 9.0.0-beta.11 | No  | pre-release          | unsupported             | 1.21.5               | 3.2.17-gravity   |
| [8.0](#80-releases) | 8.0.0-beta.9  | No  | pre-release          | unsupported             | 1.19.15              | 3.2.17-gravity   |
| [7.0](#70-releases) | 7.0.40        | Yes | June 2, 2022         | July 9, 2022            | 1.17.9               | 3.2.14-gravity   |
| [6.1](#61-releases) | 6.1.55        | Yes | January 27, 2022     | November 10, 2021       | 1.15.12              | 3.2.14-gravity   |
...
* Scrape all servicemonitors by default ([#2674](https://github.com/gravitational/gravity/pull/2674), [monitoring-app#219](https://github.com/gravitational/monitoring-app/pull/219)).

#### Bugfixes

* Fix the metrics collection of scheduler and controller-manager ([#2674](https://github.com/gravitational/gravity/pull/2674), [monitoring-app#217](https://github.com/gravitational/monitoring-app/pull/217)).
...
* Enable serf encryption mode ([#2741](https://github.com/gravitational/gravity/issues/2741), [#2742](https://github.com/gravitational/gravity/pull/2742), [planet#889](https://github.com/gravitational/planet/pull/889)).
* Add etcd-healthz check toggle ([#2740](https://github.com/gravitational/gravity/issues/2740), [#2743](https://github.com/gravitational/gravity/pull/2743), [planet#890](https://github.com/gravitational/planet/pull/890), [satellite#305](https://github.com/gravitational/satellite/pull/305)).

### 7.0.39 (April 28, 2022)

#### Bugfixes

* Fixes upgrade failures when using custom install directories ([#2734](https://github.com/gravitational/gravity/issues/2734), [#2735](https://github.com/gravitational/gravity/pull/2735)).
* Fixes failure to mount volumes in Google Cloud ([#2727](https://github.com/gravitational/gravity/issues/2727), [#2733](https://github.com/gravitational/gravity/pull/2733), [planet#886](https://github.com/gravitational/planet/pull/886)).
* Upgrade Go version to 1.17 with above bugs fixed ([#2733](https://github.com/gravitational/gravity/pull/2733), [planet#886](https://github.com/gravitational/planet/pull/886)).

### 7.0.38 (April 22, 2022)
