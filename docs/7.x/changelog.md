...
* Fix an issue with upgrades if etcd is running within a pod and the host ([#2024](https://github.com/gravitational/gravity/pull/2024), [planet#721](https://github.com/gravitational/planet/pull/721)).
* Fix an issue with version metadata within custom planet containers ([#2024](https://github.com/gravitational/gravity/pull/2024), [planet#717](https://github.com/gravitational/planet/pull/717)).
