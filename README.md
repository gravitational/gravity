...
`Telekube` is our flagship product. It allows software vendors to
upload/publish their software packages into Telekube Ops Center and let their
customers to install those applications "Bundles" onto their own private
servers.

User facing configuration is located here:

https://gravitational.com/telekube/docs/overview/
