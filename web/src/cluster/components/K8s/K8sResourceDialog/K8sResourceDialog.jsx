...
import Dialog, { DialogFooter, DialogTitle, DialogHeader, DialogContent} from 'shared/components/Dialog';
import { ButtonPrimary, ButtonSecondary, Text } from 'shared/components';
  ...
  return (
    <Dialog
      ...
      <DialogHeader justifyContent="space-between">
        <DialogTitle typography="h3" caps={false}>{name}</DialogTitle>
      ...
      <DialogContent>
        <TextEditor readOnly={readOnly} onDirty={setDirty} onChange={onChange} data={[{ content, type: 'json'}] } />
      </DialogContent>
      <DialogFooter>
        { !readOnly && (
