...
export default {
  ...
  existingServer,
  newServer,
  deleteOperationAttemp: requestStatus(TRYING_TO_DELETE_EXPAND_OPERATION),
  startOperationAttemp: requestStatus(TRYING_TO_START_EXPAND_OPERATION),
  createOperationAttemp: requestStatus(TRYING_TO_CREATE_EXPAND_OPERATION),
  serverProvision,
  servers,
  serverToRemove,
