...
import Suggestions from './querySuggestions.jsx';
...
class QueryEditor extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="grv-site-logs-query-editor">
        <div className="input-group input-group-sm">
          <div className="input-group-btn">
          <button onClick={ () => this.hideSuggestions() } type="button" className="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="trufe" aria-expanded="false">
                <span className="m-r-xs">Filter</span>
                <span className="caret" />
              </button>
              <ul className="dropdown-menu">
                <li>
                  <a onClick={ () => this.append(withSeparator(LABEL_CONTAINER)) } >
                    <i style={{fontSize: '10px'}} className="fa fa-tags m-r-xs" aria-hidden="true"></i>
                    Containers
                  </a>
                </li>
                <li>
                  <a onClick={ () => this.append(withSeparator(LABEL_POD)) } >
                    <i style={{fontSize: '10px'}} className="fa fa-tags m-r-xs" aria-hidden="true"></i>
                    Pods
                  </a>
                </li>
          ...
          <div className="input-group input-group-sm grv-site-logs-query-editor-input full-width">
            <QueryEditorInput
