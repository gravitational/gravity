...
TEST_ETCD_CONFIG := '{"nodes": ["https://localhost:4001"], "key":"/gravity/test", "tls_key_file": "$(TEST_ETCD_CERTS)/proxy1.key", "tls_cert_file": "$(TEST_ETCD_CERTS)/proxy1.crt", "tls_ca_file": "$(TEST_ETCD_CERTS)/ca.crt"}'
