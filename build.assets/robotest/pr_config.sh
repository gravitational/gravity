...
UPGRADE_MAP[$(recommended_upgrade_tag $(branch 6.3.x))]="ubuntu:18" # this branch
...
# UPGRADE_MAP[$(recommended_upgrade_tag $(branch 6.2.x))]="debian:9" # compatible non-LTS version
