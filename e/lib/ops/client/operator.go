...
func (c *Client) UpdateClusterEndpoints(key ossops.SiteKey, endpoints storage.Endpoints) error {
...
// Ops Center
func (c *Client) DownloadUpdate(req ops.DownloadUpdateRequest) error {
...
func (c *Client) EnablePeriodicUpdates(req ops.EnablePeriodicUpdatesRequest) error {
...
func (c *Client) DisablePeriodicUpdates(key ossops.SiteKey) error {
...
func (c *Client) UpsertTrustedCluster(key ossops.SiteKey, cluster storage.TrustedCluster) error {
...
func (c *Client) DeleteTrustedCluster(req ops.DeleteTrustedClusterRequest) error {
	err := req.Check()
	if err != nil {
		return trace.Wrap(err)
	}
...
func (c *Client) NewLicense(req ops.NewLicenseRequest) (string, error) {
...
func (c *Client) CheckSiteLicense(key ossops.SiteKey) error {
...
func (c *Client) UpdateLicense(req ops.UpdateLicenseRequest) error {
...
func (c *Client) UpsertRole(key ossops.SiteKey, role teleservices.Role) error {
...
func (c *Client) DeleteRole(key ossops.SiteKey, name string) error {
	if name == "" {
...
func (c *Client) UpsertOIDCConnector(key ossops.SiteKey, connector teleservices.OIDCConnector) error {
...
func (c *Client) DeleteOIDCConnector(key ossops.SiteKey, name string) error {
	if name == "" {
...
func (c *Client) UpsertSAMLConnector(key ossops.SiteKey, connector teleservices.SAMLConnector) error {
...
func (c *Client) DeleteSAMLConnector(key ossops.SiteKey, name string) error {
	if name == "" {
		return trace.BadParameter("missing connector name")
	}
