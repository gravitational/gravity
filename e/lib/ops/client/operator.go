...
func (c *Client) GetClusterEndpoints(key ossops.SiteKey) (storage.Endpoints, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "cluster-endpoints"), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) CheckForUpdate(key ossops.SiteKey) (*loc.Locator, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "updates"), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) PeriodicUpdatesStatus(key ossops.SiteKey) (*ops.PeriodicUpdatesStatusResponse, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "periodicupdates"), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) GetTrustedCluster(key ossops.SiteKey, name string) (storage.TrustedCluster, error) {
	...
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "trustedclusters", name), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) GetTrustedClusters(key ossops.SiteKey) ([]storage.TrustedCluster, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "trustedclusters"), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) GetLicenseCA() ([]byte, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("license", "ca"), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
	var response struct {
...
func (c *Client) GetRole(key ossops.SiteKey, name string) (teleservices.Role, error) {
	...
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "roles", name), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) GetRoles(key ossops.SiteKey) ([]teleservices.Role, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "roles"), url.Values{})
	if err != nil {
		return nil, trace.Wrap(err)
	}
	var items []json.RawMessage
...
func (c *Client) GetOIDCConnector(key ossops.SiteKey, name string, withSecrets bool) (teleservices.OIDCConnector, error) {
	...
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "oidc", "connectors", name),
...
func (c *Client) GetOIDCConnectors(key ossops.SiteKey, withSecrets bool) ([]teleservices.OIDCConnector, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "oidc", "connectors"),
		url.Values{constants.WithSecretsParam: []string{fmt.Sprintf("%t", withSecrets)}})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) GetSAMLConnector(key ossops.SiteKey, name string, withSecrets bool) (teleservices.SAMLConnector, error) {
	...
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "saml", "connectors", name),
		url.Values{constants.WithSecretsParam: []string{fmt.Sprintf("%t", withSecrets)}})
	if err != nil {
		return nil, trace.Wrap(err)
	}
...
func (c *Client) GetSAMLConnectors(key ossops.SiteKey, withSecrets bool) ([]teleservices.SAMLConnector, error) {
	out, err := c.Get(context.TODO(), c.Endpoint("accounts", key.AccountID, "sites", key.SiteDomain, "saml", "connectors"),
		url.Values{constants.WithSecretsParam: []string{fmt.Sprintf("%t", withSecrets)}})
	if err != nil {
		return nil, trace.Wrap(err)
	}
